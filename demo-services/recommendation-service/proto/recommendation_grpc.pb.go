...
const (
	...
	RecommendationService_GetSimilarProducts_FullMethodName = "/recommendation.RecommendationService/GetSimilarProducts"
)
...
type RecommendationServiceClient interface {
	GetRecommendations(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*ProductList, error)
	GetSimilarProducts(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductList, error)
}
...
func (c *recommendationServiceClient) GetRecommendations(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*ProductList, error) {
...
func (c *recommendationServiceClient) GetSimilarProducts(ctx context.Context, in *ProductRequest, opts ...grpc.CallOption) (*ProductList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ProductList)
...
type RecommendationServiceServer interface {
	GetRecommendations(context.Context, *UserRequest) (*ProductList, error)
	GetSimilarProducts(context.Context, *ProductRequest) (*ProductList, error)
...
func (UnimplementedRecommendationServiceServer) GetRecommendations(context.Context, *UserRequest) (*ProductList, error) {
	return nil, status.Error(codes.Unimplemented, "method GetRecommendations not implemented")
}
func (UnimplementedRecommendationServiceServer) GetSimilarProducts(context.Context, *ProductRequest) (*ProductList, error) {
...
func _RecommendationService_GetRecommendations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).GetRecommendations(ctx, req.(*UserRequest))
	}
...
func _RecommendationService_GetSimilarProducts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RecommendationServiceServer).GetSimilarProducts(ctx, req.(*ProductRequest))
	}
	return interceptor(ctx, in, info, handler)
}
