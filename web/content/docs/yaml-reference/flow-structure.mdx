...
Retry and timeout are configured per step, not at the flow level.
...
|---|---|---|---|
| `timeout` | duration | none | Maximum time for this step before it fails |
| `retry.max_attempts` | integer | `1` | Maximum retry attempts |
