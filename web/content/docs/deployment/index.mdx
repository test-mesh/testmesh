...
description: Deploy TestMesh with Docker, Kubernetes, or connect to existing infrastructure.
---

TestMesh ships as a single Go binary (API) and a Next.js dashboard. You can run it with Docker Compose in several configurations depending on what infrastructure you already have.
