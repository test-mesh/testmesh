...
Query and generate reports programmatically:

```bash
# Generate a report
curl -X POST http://localhost:5016/api/v1/workspaces/{workspace_id}/reports/generate \
...
# List reports
curl http://localhost:5016/api/v1/workspaces/{workspace_id}/reports

# Download a specific report
curl http://localhost:5016/api/v1/workspaces/{workspace_id}/reports/{id}/download
```

Supported formats: `html`, `json`, `junit`.
