...
If you use Claude Code, install the TestMesh plugin to get the MCP server and 10 built-in skills:
...
- **Skills** — `setup`, `generate-flow`, `run-flow`, `validate-flow`, `action-patterns`, `debugging-flows`, `flow-layers`, `mcp-tools`, `yaml-schema`, `coverage`
